...
//   }
template <class Request, class Response> struct ServiceCall {
  ...
  static ServiceCall<Request, Response>* Cast(void* user_data) { return static_cast<ServiceCall<Request, Response>*>(user_data); }
};
}
